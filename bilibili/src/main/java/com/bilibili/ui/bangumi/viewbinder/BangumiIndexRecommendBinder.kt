...
class BangumiIndexRecommendBinder : ItemViewBinder<BangumiIndexRecommendBinder.BangumiIndexRecommend, BangumiIndexRecommendBinder.BangumiIndexRecommendHolder>() {
